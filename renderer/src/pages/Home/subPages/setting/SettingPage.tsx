        ...
        <>
            ...
            <div style={{ display: hidden ? "none" : "block" }} className="flex flex-col h-full overflow-y-scroll">
                <mdui-list>
                    ...
                    <SettingItemSlider title="窗口不透明度" desc="修改窗口的不透明度(为避免影响扫码 该选项对连接页无效)" icon="opacity" configs={applicationConfig} configKey="windowOpacity" setConfig={ipc.setConfig} step={1} min={10} max={100} />
                    ...
                    <SettingItemSwitch title="计算机锁屏时锁定通知转发页" desc="仅在开启'通知转发记录保护'后生效" icon="screen_lock_landscape" configs={deviceConfig} configKey="protectNotificationForwardPageOnLockedScreen" setConfig={wrappedSetDeviceConfig} />
