...
export default function NavigationRail({
    ...
    return (
        <mdui-navigation-rail value={value} className="w-[10%] h-[91.5%] top-[8%] navigationRailIndex" onClick={event => onChange((event.target as MduiNavigationRail)!.value as PageRouteProps["page"])}>
            {/* 逆天替ui库修bug */}
            <mdui-navigation-rail-item className="-ml-2 pl-[11.8%] w-[60%] whitespace-nowrap" icon="home" value="home" onDragEnter={onRailItemDragEnterHandle}>主页</mdui-navigation-rail-item>
            ...
            <mdui-navigation-rail-item className="-ml-2 pl-[11.8%] w-[60%] whitespace-nowrap" icon="notifications" value="notification" onDragEnter={onRailItemDragEnterHandle}>
                通知转发
