...
// 替代mdui-select
// 自带的问题太多了 服
export default function FixedMduiSelect({ slot, className, label, items, value ,menuItemClassName,onChange,icon,variant,menuItemTextClassName,menuClassName}: FixedMduiSelectProps) {
